...
# Global Spacings
set cfg(upper_front_glb_spacing)  $cfg(spacing_1)
set cfg(upper_back_glb_spacing)   $cfg(spacing_2)
set cfg(lower_front_glb_spacing)  $cfg(spacing_1)
...
$_TMP(PW_1) apply [list [list $_BL(1) $_DM(4)] [list $_BL(1) $_DM(5)] [list $_BL(1) $_DM(6)] [list $_BL(1) $_DM(7)] [list $_BL(1) $_DM(8)]]
pw::Application markUndoLevel {Set BC}
