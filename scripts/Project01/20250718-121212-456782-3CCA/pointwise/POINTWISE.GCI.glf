...
set cfg(prof_path)                "../_data/AH63K127_processed.dat"
set cfg(grid_path)                "../mesh/mesh.cas"
set cfg(proj_path)                "GCI.pw"

set cfg(chord_length)             0.431
set cfg(split_percentage)         0.4
set cfg(ff_factor)                20
set cfg(ff_radius)                [expr {$cfg(ff_factor)*$cfg(chord_length)}]
set cfg(ff_center)                {0 0 0}
set cfg(ff_dimension)             600

# Dimensions
set cfg(dim_back_connectors)      160
set cfg(upper_front_dim)          160
set cfg(upper_back_dim)           160
set cfg(lower_front_dim)          160
set cfg(lower_back_dim)           160
set cfg(te_dim)                   4

set cfg(spacing_1)                8e-05
set cfg(spacing_2)                0.00024
set cfg(refinement)               8.0
...
#trex
set cfg(trex_first_height)        1.9037998954788055e-06
set cfg(trex_growth_rate_cond)    1.15
set cfg(trex_max_layers)          500
set cfg(trex_full_layers)         10
set cfg(trex_growth_rate_attr)    1.15
set cfg(size_field_decay)         0.95

#extrusion
set cfg(z_distance)               0.0431
...
$_TMP(PW_4) setName symm
pw::Application markUndoLevel {Name BC}

$_TMP(PW_4) setPhysicalType -usage CAE Symmetry
...
unset _TMP(PW_3)
unset _TMP(PW_4)
set _DM(1) [pw::GridEntity getByName dom-5]
...
set _TMP(PW_4) [pw::BoundaryCondition getByName stub]
$_TMP(PW_4) apply [list [list $_BL(1) $_DM(6)] [list $_BL(1) $_DM(7)] [list $_BL(1) $_DM(8)]]
pw::Application markUndoLevel {Set BC}
