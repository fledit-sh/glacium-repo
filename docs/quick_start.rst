...
above results in a 30‑second icing run. Values like ``ICE_GUI_TOTAL_TIME``,
``ICE_NUMBER_TIME_STEP``, ``ICE_GUI_TIME_BETWEEN_OUTPUT``, and
``ICE_TIME_STEP_BETWEEN_OUTPUT`` are derived from this total and injected
automatically.
